sys.path =  []
os.environ["TT_GAMESERVER"] = corpclash.net
ToontownCilentStart: Starting the game.
ToontownCilentStart: setting default font
...
:display:windisplay:   
:display:windisplay: max Mhz 2401000000, current Mhz 1500000000
